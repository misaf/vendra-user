...
The `misaf/vendra-user` package owns user management, authentication, media handling, and multi-tenant membership and the Filament admin UI for users and socialite identities.

### Standards

- Keep user domain code inside `app-modules/vendra-user` using the `Misaf\VendraUser` namespace.
